...
//        ArrayList<GTLineMap> list_village = dao.regionalSearch_village("雙坑里");
//
//        for (GTLineMap gtl : list_village) {
//
...
//        }
        ...
        ArrayList<GTLineMap> list_city = dao.regionalSearch_city("板橋區");
        
        for (GTLineMap gtl : list_city) {
